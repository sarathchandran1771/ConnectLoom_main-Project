...
export default function PostReportUser(props) {
...
console.log("user to report", userId)
  const addReportOnUser = async () => {
    try {
      const response = await reportOnProfile({
        reportedBy: loggedInId,
        reportedUser: userId,
